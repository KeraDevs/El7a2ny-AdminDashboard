  ...
  return (
    <Card sx={{ borderRadius: 2, boxShadow: 2 }}>
      ...
      <Dialog
        ...
        PaperProps={{ sx: { borderRadius: 2 } }}
      >
        <DialogTitle>Confirm Add Worker</DialogTitle>
        <DialogContent>
          <Typography>Are you sure you want to add this new Worker?</Typography>
        </DialogContent>
      ...
      >
        ...
        <DialogContent>
          <Typography>
            Are you sure you want to update this worker's information?
          </Typography>
        </DialogContent>
        <Box sx={{ p: 2, display: "flex", justifyContent: "flex-end", gap: 1 }}>
          <Button
